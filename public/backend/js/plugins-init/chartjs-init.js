            ...
            datasets: [
              {
                ...
                backgroundColor: ["rgba(11, 42, 151, 1)", "rgba(39, 188, 72, 1)", "rgba(139, 199, 64, 1)"],
                hoverBackgroundColor: ["rgba(11, 42, 151, 0.9)", "rgba(39, 188, 72, .9)", "rgba(139, 199, 64, .9)"]
              }
            ]
            // labels: [
            //     "green",
            ...
            datasets: [
              {
                data: [15, 18, 9, 6, 19],
                borderWidth: 0,
                backgroundColor: ["rgba(11, 42, 151, 1)", "rgba(39, 188, 72, 1)", "rgba(139, 199, 64, 1)", "rgba(255, 46, 46, 1)", "rgba(255, 188, 17, 1)"]
              }
            ]
          },
          options: {
