                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-1">Instrutor João alterou os dados do aluno
                                                    Pedro Paulo</h6>
                                                <small class="d-block">29/03/2022 - 15:30h</small>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-1">Aluno(a) Maria Silva em transferência de Polo
                                                </h6>
                                                <small class="d-block">29/03/2022 - 15:30h</small>
                                            </div>
                                        </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            <img src="{!! \Auth::guard('web')->user()->getImage() !!}" width="20" alt="" />
                            <div class="header-info">
                                <span class="text-black"><strong>{!! \Auth::guard('web')->user()->name !!}</strong></span>
                                <p class="fs-12 mb-0">{!! \Auth::guard('web')->user()->surname !!}</p>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">

                            <a href="{{ route('backend.profile') }}" class="dropdown-item ai-icon">
                            ...
                            <a href="{{ route('backend.auth.logout') }}" class="dropdown-item ai-icon">
