            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            {!! $content->isFilled() ? \Lang::choice('tables.edit', 's') : \Lang::choice('tables.new', 's') !!} {!! \Lang::choice('tables.partners', 's') !!}
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" method="POST"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                        <div class="col-12 d-flex align-items-center justify-content-center">
                                            <code>Dimensão da Imagem: 250x250 (pixels)</code>
                                        </div>
                                        <label for="file"
                                ...
                                <div class="form-row mt-4">
                                    <div class="form-group col-md-3">
                                        <label>Tipo</label>
                                        <select id="" name="type" class="form-control default-select">
                                            <option value="1" {{ $content->getValue('type') === 1 ? 'selected' : '' }}>
                                                Mantenedores
                                            </option>
                                            <option value="2" {{ $content->getValue('type') === 2 ? 'selected' : '' }}>
                                                Institucionais
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" value="{!! $content->getValue('url') !!}" name="url"
                                            class="form-control">
                                    </div>
