...
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">{!! \Lang::choice('tables.action-lines', 'p') !!}</a></li>
        </ol>
    </div>
    <!-- row -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Listagem de {!! \Lang::choice('tables.action-lines', 'p') !!}</h4>
                    <a href="{{route($route . '.create')}}" class="btn light btn-secondary">Novo {!! \Lang::choice('tables.action-lines', 's') !!}</a>
                </div>
                <div class="card-body">
