            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route($route . '.index') }}">
                        {!! \Lang::choice('tables.posts-instagram', 'p') !!}
                    </a>
                </li>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{!! $content->isFilled() ? \Lang::choice('tables.edit', 's') : \Lang::choice('tables.new', 's') !!} {!! \Lang::choice('tables.posts-instagram', 's') !!}</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                        <div class="col-12 d-flex align-items-center justify-content-center">
                                            <code>Dimensão da Imagem: 370x370 (pixels)</code>
                                        </div>
                                        <label for="file"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label>Link</label>
                                                <input type="text" value="{!! $content->getValue('link') !!}" name="link"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Status</label>
                                                <select id="inputStatus" name="status" class="form-control default-select">
                                                    <option value="1"
                                                        {{ $content->getValue('status') ? 'selected' : '' }}>Ativo
                                                    </option>
                                                    <option value="0"
                                                        {{ !$content->getValue('status') ? 'selected' : '' }}>Inativo
                                                    </option>
                                                </select>
                                            </div>
