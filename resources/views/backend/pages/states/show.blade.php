        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{!! $content->isFilled() ? \Lang::choice('tables.edit', 's') : \Lang::choice('tables.new', 's') !!} {!!\Lang::choice('tables.states', 's')!!}</h4>
                </div>
                <div class="card-body">
                    <div class="basic-form">
                        <form enctype="multipart/form-data" method="POST"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    <label>País</label>
                                    <select id="inputCountry" name="country_id" class="form-control default-select">
                                        @foreach($countries as $key => $value)
                                        <option {{($content->country_id === $value->getId()) ? 'selected' : ''}} value="{{$value->getId()}}">{!!$value->name!!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-2">
