    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{!! \Lang::choice('tables.newsletter', 'p') !!}</a></li>
            </ol>
        </div>
        <!-- row -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Listagem de {!! \Lang::choice('tables.newsletter', 'p') !!}</h4>
                        <a href="{{ route('backend.frontend.newsletter.export') }}"
                            class="btn light btn-warning btn-open-search-advanced">
                            Exportar Excel
                        </a>
                    </div>
                    <div class="card-body">
