                                        ...
                                        <div class="accordion__body--text">
                                            <div class="basic-form pt-5">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-sm-3 col-md-3 col-lg-3 pb-4">
                                                        <label for="image">
                                                            Logo/Icone
                                                        </label>
                                                        <div class="col-12 d-flex align-items-center justify-content-center">
                                                            <code>Dim. da Imagem: 150x150</code>
                                                        </div>
                                                        <label for="image"
                                                            ...
                                                            <input type="file" name="file-image"
                                                                class="image-product" id="image"
                                                                style="display: none">

                                                        </label>
                                                    </div>

                                                    <div class="form-group col-sm-9 col-md-9 col-lg-9 pb-4">
                                                        <label for="institutional_image">
                                                            Imagem Institucional 
                                                        </label>
                                                        <div class="col-12 d-flex align-items-center justify-content-center">
                                                            <code>Dimensão da Imagem: 770x500 (pixels)</code>
                                                        </div>
                                                        <label for="institutional_image"
                                                            class="select-image banner-horizontal card d-flex align-items-center {{ isset($content) && $content->isFilled() && $content->getImage('originals', 'institutional_image') ? 'visible' : '' }}"
                                                            style="background-image: url({{ isset($content) && $content->isFilled() && $content->getImage('originals', 'institutional_image') ? $content->getImage('originals', 'institutional_image') : '' }}); background-position: center; margin-bottom: 10px; background-size: cover;">
                                                            <span class="d-flex align-self-center" style="top: 10%">
                                                                {{ isset($content) && $content->isFilled() && $content->getImage('originals', 'institutional_image') ? 'Alterar' : 'Selecionar' }}
                                                                Imagem
                                                            </span>
                                                            <input type="file" name="file-institutional_image"
                                                                class="image-product" id="institutional_image"
                                                                style="display: none">
