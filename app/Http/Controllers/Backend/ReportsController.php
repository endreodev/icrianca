...
class ReportsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->path         = 'reports';
        $this->route        = 'backend.frontend.reports';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('file-archive')) {
                $request->merge([
                    'file' => $this->uploadFile($request,  $attr = 'file-archive')
                ]);
            }
    ...
    public function trashFile(Request $request, $id)
    {
        # Init transaction
        \DB::beginTransaction();
        try {
