...
# --  
use App\Models\PostsInstagram as Model;
...
class PostsIntagramController extends Controller
{
    use Upload;
    ...
    public function __construct()
    {
        ...
        $this->path         = 'posts-instagram';
        $this->route        = 'backend.frontend.posts-instagram';
