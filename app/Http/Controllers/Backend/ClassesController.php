...
# --  
use App\Models\Classe as Model;
...
class ClassesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->input('educators')) {
                $created->trainers()->sync($request->input('educators'));
            } else {
                $created->trainers()->sync([]);
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->input('educators')) {
                $content->trainers()->sync($request->input('educators'));
            } else {
                $content->trainers()->sync([]);
            }
