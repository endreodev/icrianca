...

{
...

    {
        ...
        // API Gerada pelo Aloisio Bueno 10082023
                ...
                // Removidas API keys por segurança - agora usando .env
        $this->api_key = config('app.sendgrid_api_key');



        $this->service_name = config('app.service_sendgri_name') ?: 'Instituto Desportivo da Criança';
        ...
        $this->service_email = config('app.service_sendgri_email') ?: 'aloisio@harmonysistemas.com.br';
